...
class HomePageController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = ["settings" => $settings, "slides" => $slides,"services" => $services, "staticpages" => $staticpages, "allcategories" => $allcategories, "status" => "success", "products" => $products, "categories" => $categories, "tree" => $tree];
