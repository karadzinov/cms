...
@section('opengraph')
    ...
    <meta itemprop="name" content="Fruti Smoothie - {!! $service->title !!}">
    <meta itemprop="description" content="{!! str_limit(strip_tags($service->description), 155) !!}">
    <meta itemprop="image" content="http://frutismoothie.mk/assets/img/services/{{ $service->image }}">

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="@FrutiSmoothie">
    <meta name="twitter:title" content="Fruti Smoothie">
    <meta name="twitter:description" content="{!!  str_limit(strip_tags($service->description), 155) !!}">
    <meta name="twitter:creator" content="@FrutiSmoothie">
    <meta name="twitter:image" content="http://frutismoothie.mk/assets/img/services/{{ $service->image }}">
    ...
    <meta property="og:image" content="http://frutismoothie.mk/assets/img/services/{{ $service->image }}" />
    <meta property="og:description" content="{!! str_limit(strip_tags($service->description), 155) !!}" />
    <meta property="og:site_name" content="Fruti Smoothie - {!! $service->title !!}" />
@endsection
                ...
                <div class="left-blog left-single">
                    <div class="blog-left">
                        <div class="single-left-left wow fadeInUp animated" data-wow-delay=".5s">
                            <p> Почетна / <a href="#">{{ $service->title }}</a></p>
                            <img src="/assets/img/services/{{ $service->image }}" alt="{{ $service->title }}"/>
                        </div>
