      ...
      <div class="profile-container">
        <div class="profile-header row">
          <div class="col-lg-2 col-md-4 col-sm-12 text-center">
           @if(!!$user->image)
           <img src="/assets/img/avatars/thumbnails/{{ $user->image }}" alt="{{ $user->name }}" class="header-avatar" />
           @endif
         </div>
        ...
        <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 profile-stats">
          ...
          <div class="row">
           ...
           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 inlinestats-col">
             <a href="/admin/users/{{ $user->id }}/edit" class="btn btn-labeled shiny btn-warning edit"><i class="btn-label fa fa-edit"></i> Edit</a>
           </div>
           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 inlinestats-col">
